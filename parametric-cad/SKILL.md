---
name: parametric-cad
description: Use when driving a parametric CAD tool through an MCP server — Autodesk Fusion 360 (official Fusion MCP, faust-machines/fusion360-mcp-server, FusionMCP), FreeCAD (neka-nat/freecad-mcp), OnShape, SolidWorks, OpenSCAD, CadQuery, or Build123d-MCP. Covers parameter-driven modeling, sketch discipline, the render→measure→iterate workflow, tool-discovery conventions, common gaps in CAD MCPs (assemblies, constraints, drawings, simulation), and CAD patterns specific to loudspeaker cabinets (driver cutouts, ports, bracing, joinery, exports for CNC/laser).
---
